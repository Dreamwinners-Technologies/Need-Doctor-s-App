      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            textFormBox(label: "Symptoms of the Disease", hint: "Enter Symptoms", textController: indicationsController),
            textFormBox(label: "Medicine Dosage", hint: "Enter Dosage", textController: adultDoseController),
            ...
            textFormBox(label: "Medicine Administration", hint: "Enter Administration", textController: administrationController),
            textFormBox(label: "Medicine Contraindications", hint: "Enter Contraindications", textController: contraindicationsController),
            textFormBox(label: "Side Side effect on Human", hint: "Enter Side effect", textController: sideEffectsController),
            textFormBox(
                label: "Safety Measure And Caution",
