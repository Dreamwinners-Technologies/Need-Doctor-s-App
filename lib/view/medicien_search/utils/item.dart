  ...
  return GestureDetector(
    onTap: () {
      ...
      Navigator.push(context,
          PageTransition(type: PageTransitionType.rightToLeft, child: DragDetails(drugModelList[index], medicineType)));
    },
    child: Container(
      height: 115.0,
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(7.0), border: Border.all(width: 1, color: Color(0xffe7e7e7))),
      ...
      children: [
        GestureDetector(
            onTap: () {
              print("Click");
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => EditMedicine(_pagingController.itemList[index])));
            },
            child: Icon(
              Icons.edit,
              color: primarylight,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 200.0,
                      child: sText(drugModelList[index].generic, blackcolor.withOpacity(0.7), 14.0, FontWeight.w500),
                    ),
                    Container(
                      width: 200.0,
