...
class ambulanceItem extends StatelessWidget {
  ambulanceItem({Key key, this.isAdmin, this.pagingController, this.index}) : super(key: key);
  bool isAdmin;
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Container(width: double.infinity, child: sText(pagingController.itemList[index].name, primarycolor, 19.0, FontWeight.bold)),
                Container(
                  margin: EdgeInsets.only(top: 5.0),
                  width: double.infinity,
                  child: mText1(pagingController.itemList[index].specialization, Colors.black.withOpacity(0.8), 16.0, FontWeight.w500),
                ),
                Container(
