...
class _AmbulanceState extends State<Ambulance> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      ...
      // if (name.length != 0 && isChecked == false) {
      //   print("Type Search");

      //   query =
      //       (box.query(ListOfAmbulance_.address.startsWith(name.toUpperCase()))
      //             ..order(ListOfAmbulance_.address, flags: Order.caseSensitive))
      //           .build();
      //   // if (query.count() != 0) {
      ...
      // }
      //  else if (name.length != 0 && isChecked == true) {
      //   print('Type and selection search');
      //   doSelectionQuery(query, box, pageKey);
      //   query =
      //       (box.query(ListOfAmbulance_.address.startsWith(name.toUpperCase()))
      //             ..order(ListOfAmbulance_.address, flags: Order.caseSensitive))
      ...
      // if (name.length != 0 && isChecked == true) {
      //   if (name.length != 0 &&
      //       _selectedDistrict == null &&
      //       _selectedDivision == null &&
      //       _selectedThana == null) {
      //     query = (box.query(
      //             ListOfAmbulance_.address.startsWith(name.toUpperCase()))
      //           ..order(ListOfAmbulance_.address, flags: Order.caseSensitive))
      //         .build();
      //     doSelectionQuery(query, box, pageKey);
      //   } else {
