          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                ...
                SizedBox(width: 15,),
                Text('My Profile', style: TextStyle(color: Color(0xff008080), fontSize: 18, fontWeight: FontWeight.bold),),
...
_buildTextField1(
  ...
  return Container(
    ...
    decoration: BoxDecoration(border: Border(bottom: BorderSide( color: Color(0xff008080)))),
    child: TextField(
