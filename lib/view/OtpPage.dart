      ...
      body: CustomPaint(
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              FadeAnimation(1, Image.asset('asset/password.png'),),
              ...
              Align(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    SizedBox(height: 10,),
                    FadeAnimation(1,
                      Text("Don't get the OTP?", style: TextStyle(color: Color(0xff008080), fontSize: 18),),),
                    FadeAnimation(1,
                      FlatButton(
                        onPressed: (){
                          print('Pressed');
                        ...
                        child:
                        Text('Resend OTP.', style: TextStyle(color: Color(0xff008080), fontSize: 18, fontWeight: FontWeight.bold),),),),
                  ],
                ),
              ),
              SizedBox(height: 60,),
