  ...
  Route onGenerateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case START:
        ...
        ); //Change here for check as a start view
        break;
      //login
      case LOGIN_VIEW:
        return PageTransition(type: PageTransitionType.rightToLeft, child: LoginScreen());
        break;
      //register
      case REGISTER_VIEW:
        return PageTransition(type: PageTransitionType.rightToLeft, child: RegistrationPage());
        break;
      ...
      case BOTTOM_VIEW:
        return PageTransition(type: PageTransitionType.fade, child: PageSetup());
        break;

      case APPOINTMENT_ROUTE:
        return PageTransition(type: PageTransitionType.fade, child: GetAppointmentViw());
        break;

      case PYMENT_ROUTE:
        var information = settings.arguments;
        return PageTransition(type: PageTransitionType.fade, child: PymentView(information: information));
        break;
      default:
