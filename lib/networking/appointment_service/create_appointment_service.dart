...
class CreateAppointmentService {
  Future<MessageIdResponse> createAppointment(AppointmentModel appointment, BuildContext context) async {
    ...
    try {
      res = await http.post(ENV.SERVER_IP + "/appointments", headers: headers, body: requestAppointmentData);
