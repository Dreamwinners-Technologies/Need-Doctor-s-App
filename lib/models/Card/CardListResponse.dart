...
CardListResponse cardListResponseFromJson(String str) =>
    CardListResponse.fromJson(json.decode(str));

String cardListResponseToJson(CardListResponse data) =>
...
class CardListResponse {
  ...
  factory CardListResponse.fromJson(Map<String, dynamic> json) =>
      CardListResponse(
        cardInfoResponseList: List<CardInfoResponse>.from(
            json["cardInfoResponseList"]
                .map((x) => CardInfoResponse.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "cardInfoResponseList":
            List<dynamic>.from(cardInfoResponseList.map((x) => x.toJson())),
        "lastPage": lastPage,
        "pageNo": pageNo,
        "pageSize": pageSize,
        "totalItem": totalItem,
