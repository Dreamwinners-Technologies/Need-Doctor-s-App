final List districtListJson = [
  ...
  {"id": 11, "name": "Bandarban - বান্দরবান"},
  {"id": 35, "name": "Barguna - বরগুনা"},
  {"id": 33, "name": "Barisal - বরিশাল"},
  {"id": 34, "name": "Bhola - ভোলা"},
  {"id": 14, "name": "Bogura - বগুড়া "},
  {"id": 3, "name": "Brahmanbaria - ব্রাক্ষণবাড়িয়া"},
  {"id": 6, "name": "Chandpur - চাঁদপুর"},
  {"id": 18, "name": "Chapainawabganj - চাঁপাইনবাবগঞ্জ"},
  {"id": 8, "name": "Chattogram - চট্টগ্রাম "},
  {"id": 24, "name": "Chuadanga - চুয়াডাঙ্গা "},
  {"id": 1, "name": "Comilla - কুমিল্লা "},
  {"id": 9, "name": "Coxsbazar - কক্সবাজার"},
  {"id": 47, "name": "Dhaka District -  ঢাকা জেলা"},
  {"id": 80, "name": "Dhaka-North - ঢাকা উত্তর"},
  {"id": 81, "name": "Dhaka-South - ঢাকা দক্ষিন"},
  ...
  {"id": 45, "name": "Kishoreganj - কিশোরগঞ্জ"},
  ...
  {"id": 37, "name": "Moulvibazar - মৌলভীবাজার"},
  {"id": 48, "name": "Munshiganj - মুন্সিগঞ্জ"},
  {"id": 62, "name": "Mymensingh - ময়মনসিংহ"},
  {"id": 19, "name": "Naogaon - নওগাঁ"},
  {"id": 23, "name": "Narail - নড়াইল"},
  {"id": 43, "name": "Narayanganj - নারায়ণগঞ্জ"},
  {"id": 40, "name": "Narsingdi - নরসিংদী "},
  {"id": 16, "name": "Natore - নাটোর"}, 
  {"id": 64, "name": "Netrokona - নেত্রকোনা "},
  {"id": 56, "name": "Nilphamari - নীলফামারী"},
